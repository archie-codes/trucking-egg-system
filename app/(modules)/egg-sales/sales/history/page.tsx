    ...
    <div className="mx-auto flex flex-col h-[calc(100vh-112px)] w-full min-w-0 overflow-hidden gap-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 shrink-0">
        <div className="space-y-1 relative">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium text-sm sm:text-base ml-1">
            Historical outbound deliveries and Accounts Receivable tracking
          </p>
        </div>
      </div>
      ...
      <div className="animate-in fade-in duration-300 flex-1 flex flex-col min-h-0">
        <DataTable data={sales} isAdmin={isAdmin} />
      </div>
    </div>
  );
}
