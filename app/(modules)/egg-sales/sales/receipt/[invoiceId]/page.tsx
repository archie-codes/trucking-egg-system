...
export default async function ReceiptPage({
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900/50 p-4 sm:p-8 print:bg-white print:p-0">
      ...
      <div className="max-w-2xl mx-auto bg-white border border-slate-200 shadow-xl rounded-2xl p-8 print:shadow-none print:border-2 print:border-slate-800 print:rounded-2xl print:p-8 text-slate-900">
