...
export function DataTable<TData>({ columns, data }: DataTableProps<TData>) {
  ...
  const isAnyFilterActive =
    globalFilter.length > 0 || selectedFarm !== "all" || !!dateRange.from;
      ...
      <div className="flex flex-col flex-1 min-h-0 gap-3 print:hidden">
        ...
        <div className="flex flex-col gap-2.5 shrink-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
            ...
            >
              <SelectTrigger
                className={cn(
                  ...
                  selectedFarm !== "all" &&
                    "text-amber-600 dark:text-amber-500 border-amber-500/40 font-bold bg-amber-50/40 dark:bg-amber-950/20",
                )}
              >
                ...
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      ...
                      dateRange.from &&
                        "text-amber-600 dark:text-amber-500 font-bold bg-amber-50/40 dark:bg-amber-950/20 border-amber-500/40",
                    )}
                  >
                    <CalendarIcon className="mr-2 h-3.5 w-3.5 shrink-0 text-amber-600 dark:text-amber-500" />
            ...
            >
              <SelectTrigger className="h-8 sm:h-8.5 w-[80px] sm:w-[90px] text-[10px] sm:text-xs bg-background border-border/60 rounded-lg focus:ring-1 focus:ring-amber-500/40 cursor-pointer">
                <SelectValue />
              </SelectTrigger>
